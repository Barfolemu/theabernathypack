        ...
        <nav className="flex items-center gap-4">
          {login ? (
            <>
              ...
              {/* Events & My Pack duplicate the mobile bottom nav, so only show them at lg+. */}
              <Link href="/events" className="hidden underline-offset-4 hover:underline lg:inline">
                Events
              </Link>
              <Link href="/pack" className="hidden underline-offset-4 hover:underline lg:inline">
                My Pack
              </Link>
